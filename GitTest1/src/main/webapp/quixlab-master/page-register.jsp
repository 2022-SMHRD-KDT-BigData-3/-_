                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                    ...
                                    <a class="text-center" href="index.html"> <h4>회원가입</h4></a>
        
                                <form class="mt-5 mb-5 login-input" action="../JoinServiceCon" method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="nick" placeholder="닉네임을 입력하세요" required>
                                    </div>
                                    <div class="form-group">
